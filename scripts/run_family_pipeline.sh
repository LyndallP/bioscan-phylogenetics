...
echo ""
echo "------------------------------------------------------------"
echo "  NEXT STEP: Upload outputs to bioscan-phylogenetics"
echo "------------------------------------------------------------"
echo ""
echo "  Run these commands from your repo root:"
echo ""
echo "    git checkout main"
echo "    mkdir -p data/${FAMILY}"
echo "    cp ${FINAL_TREE}  data/${FAMILY}/"
echo "    cp ${FINAL_META}  data/${FAMILY}/"
echo "    git add data/${FAMILY}/"
echo "    git commit -m \"Add ${FAMILY} tree and metadata\""
echo "    git push origin main"
echo "    git checkout claude/audit-bioscan-scripts-9Nd2A"
echo ""
echo "  GitHub Actions will regenerate index.html automatically."
echo ""
echo "  Direct Taxonium URL:"
TAXONIUM_BASE="https://taxonium.org/"
RAW_BASE="https://raw.githubusercontent.com/LyndallP/bioscan-phylogenetics/main"
