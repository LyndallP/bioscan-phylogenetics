  ...
  <div class="metadata-guide">
    ...
    <table class="metadata-table">
      ...
      <tbody>
        ...
        <tr><td><code>category</code></td><td>Specimen source category</td><td><strong>BIN_collected_in_BIOSCAN</strong> = BIOSCAN UK specimen &nbsp;|&nbsp; <strong>UKSI_no_specimens</strong> = UKSI-listed species, no BIOSCAN specimens yet &nbsp;|&nbsp; <strong>Europe_reference</strong> = European reference barcode &nbsp;|&nbsp; <strong>Not_in_UKSI</strong> = Not in UK Species Inventory</td></tr>
